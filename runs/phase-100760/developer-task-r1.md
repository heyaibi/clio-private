...
## Signal nonce for this invocation: `520e7f52`

Append this nonce as a separate token after your signal word, e.g. `STAGE_DONE 520e7f52` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `REVIEW_DONE findings=<path> 520e7f52`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
