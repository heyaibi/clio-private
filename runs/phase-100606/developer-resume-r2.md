...
- Working tree: 20 tracked file(s) touched (showing up to 20):
  M  README.md
  M  crates/clio-belief/src/history.rs
  M  crates/clio-belief/src/history_tests.rs
  M  crates/clio-belief/src/lib.rs
  M  crates/clio-belief/src/observe.rs
  A  crates/clio-belief/src/observe_context_tests.rs
  M  crates/clio-belief/src/observe_flow_tests.rs
  M  crates/clio-belief/src/observe_tests.rs
  M  crates/clio-belief/src/read_tests.rs
  M  crates/clio-compliance/src/audit_tests.rs
  M  crates/clio-compliance/src/export_tests.rs
  M  crates/clio-compliance/src/import_fixture.rs
  A  crates/clio-compliance/src/import_fixture_signals.rs
  M  crates/clio-compliance/src/import_rows.rs
  ...
  M  crates/clio-history/src/similar_tests.rs
...
## Signal nonce for this invocation: `c343e24d`

Append this nonce as a separate token after your signal word, e.g. `REMEDIATOR_DONE c343e24d` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `ADVERSARY_DONE findings=<path> c343e24d`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
