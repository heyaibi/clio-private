#!/usr/bin/env python3
"""Remediator r1 reproduction of the adversary helper: compare pre-change and post-change `clio recall --output json`.
...
def main() -> int:
    ...
    with open(os.path.join(RUN, "remediator-pre-post-compare.json"), "w") as handle:
