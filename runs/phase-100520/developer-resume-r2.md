...
- Working tree: 6 tracked file(s) touched (showing up to 20):
   M README.md
   M crates/clio-config/src/lib.rs
   M crates/clio-hygiene/src/audit.rs
   M crates/clio-hygiene/src/lib.rs
   M crates/clio-index/src/http.rs
   M crates/clio-index/src/lib.rs
- Diff stat:
   README.md                        |   4 ++
   crates/clio-config/src/lib.rs    |   3 ++
   crates/clio-hygiene/src/audit.rs | 113 ++++++++++++++++++++++++++++++---------
   crates/clio-hygiene/src/lib.rs   |   2 +
   crates/clio-index/src/http.rs    | 113 +++++++++++++++++++++++----------------
   crates/clio-index/src/lib.rs     |   4 +-
...
## Signal nonce for this invocation: `21f62332`

Append this nonce as a separate token after your signal word, e.g. `REMEDIATOR_DONE 21f62332` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `ADVERSARY_DONE findings=<path> 21f62332`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
