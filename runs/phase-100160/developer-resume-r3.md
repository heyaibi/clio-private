...
- Working tree: 2 tracked file(s) touched (showing up to 20):
   M .workflows/phase-100160/resume.json
   D .workflows/phase-100160/run.json
- Diff stat:
   .workflows/phase-100160/resume.json | 12 ++++++------
   .workflows/phase-100160/run.json    | 28 ----------------------------
...
## Signal nonce for this invocation: `6154f333`

Append this nonce as a separate token after your signal word, e.g. `REMEDIATOR_DONE 6154f333` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `ADVERSARY_DONE findings=<path> 6154f333`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
