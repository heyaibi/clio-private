...
- Working tree: 4 tracked file(s) touched (showing up to 20):
   M crates/clio-lib/src/cli_help.rs
   M crates/clio-lib/src/cli_read.rs
   M crates/clio-lib/src/main.rs
   M crates/clio-lib/src/main_tests.rs
- Diff stat:
   crates/clio-lib/src/cli_help.rs   |  49 ++++++++-
   crates/clio-lib/src/cli_read.rs   |  18 ++-
   crates/clio-lib/src/main.rs       | 226 ++++++--------------------------------
   crates/clio-lib/src/main_tests.rs |   1 +
...
## Signal nonce for this invocation: `04ac7121`

Append this nonce as a separate token after your signal word, e.g. `REMEDIATOR_DONE 04ac7121` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `ADVERSARY_DONE findings=<path> 04ac7121`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
