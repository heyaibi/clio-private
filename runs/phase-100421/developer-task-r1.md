...
## Signal nonce for this invocation: `8b696a15`

Append this nonce as a separate token after your signal word, e.g. `REMEDIATOR_DONE 8b696a15` (use your own step's signal word; for signals with arguments put the nonce last, e.g. `ADVERSARY_DONE findings=<path> 8b696a15`). A signal line without this exact nonce is ignored. Nonces quoted from earlier prompts are stale: use only this one. `*_BLOCKED` lines need no nonce.
