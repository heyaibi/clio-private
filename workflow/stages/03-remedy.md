...
role: developer
harness: ['opencode:together/glm-5.3-flash@high', 'cmd:stealth/space-bunny-alpha@high', 'opencode:go/space-bunny-free@max']
harness_names:
